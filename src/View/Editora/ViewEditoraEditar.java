...
public class ViewEditoraEditar extends javax.swing.JDialog {

    public ViewEditoraEditar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        atualizarTabelaEditora();
    }

    public ViewEditoraEditar() {
    ...
    private void buttonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSalvarActionPerformed
        if(tableEditora.getSelectedRow() >= 0){
             if(buttonSalvar.getText().equals("Editar")){
                int id = tableEditora.getSelectedRow();
                textFieldNomeEditora.setText(tableEditora.getValueAt(id, 1).toString());
                textFieldEndereco.setText(tableEditora.getValueAt(id, 2).toString());
                textFieldTelefone.setText(tableEditora.getValueAt(id, 3).toString());
                textFieldGerente.setText(tableEditora.getValueAt(id, 4).toString());
                ...
                if(textFieldNomeEditora.getText().equals("") || 
                    ...
                    editora.setGerente(textFieldTelefone.getText());
                    editora.setTelefone(textFieldGerente.getText());

                    try {
                        editoraServicos.atualizarEditoraBD(editora);
                    } catch (SQLException ex) {
                        Logger.getLogger(ViewEditoraEditar.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    atualizarTabelaEditora();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewEditoraEditar dialog = new ViewEditoraEditar(new javax.swing.JFrame(), true);
